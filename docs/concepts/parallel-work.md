...
- **Locked:** a ready item whose files another running item holds waits, and the ramp names the file and the holder: `#18 ui: settings panel   locked: token.ts in use by #11`.
